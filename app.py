...
app = Flask(__name__)
app.secret_key = 'physics102-cbt-secret-key-2024'

# ============================================================
# ALL 100 QUESTIONS (same as before, embedded for web use)
# ============================================================
...
QUESTIONS = [
    {
        ...
        "answer": 0,
        "explanation": "Using Coulomb's Law: F = k|q₁q₂|/r² = (9×10⁹)(2×10⁻⁶)(3×10⁻⁶)/(0.1)² = 5.40 N. The force is attractive since the charges are opposite."
    },
    {
        ...
        "answer": 0,
        "explanation": "Fₑ = k(e²)/r² = 8.2×10⁻⁸ N. Fg = G(mₑmₚ)/r² = 3.7×10⁻⁴⁷ N. Ratio Fₑ/Fg = 8.2×10⁻⁸/3.7×10⁻⁴⁷ ≈ 2.2×10³⁹. Electrical force is vastly stronger than gravity."
    },
    {
    ...
    },
    {
        ...
        "answer": 0,
        "explanation": "F₁₂ = k|q₁q₂|/r₁₂² = (9×10⁹)(1×10⁻⁶)(2×10⁻⁶)/(0.1)² = 1.8 N (attractive, +y). F₁₃ = k|q₁q₃|/r₁₃² = (9×10⁹)(1×10⁻⁶)(4×10⁻⁶)/(0.2)² = 0.9 N (attractive, +x). F_net = √(1.8² + 0.9²) = √4.05 ≈ 2.01 N."
    },
    {
...
@app.route('/')
def index():
    """Start page - initialize session and show start button"""
    session.clear()
    session['score'] = 0
...
def submit():
    ...
    if correct:
        ...
        wrong = {
            'question_num': idx + 1,
            'question': q['question'],
            'your_answer': q['options'][user_answer] if 0 <= user_answer < 4 else "No answer",
            'correct_answer': q['options'][q['answer']],
            'explanation': q['explanation']
        }
        wrongs = session.get('wrong_answers', [])
        wrongs.append(wrong)
        session['wrong_answers'] = wrongs
